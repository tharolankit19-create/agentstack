...
export const alt = "KryxAI — finished marketing work, ready for approval";
...
export default function OpenGraphImage() {
  ...
  return new ImageResponse(
    <div style={{ width:"100%", height:"100%", display:"flex", background:"#f4f0e8", color:"#15120f", padding:"56px 64px", fontFamily:"Arial, sans-serif", borderTop:"12px solid #c2571a" }}>
      <div style={{ display:"flex", width:"51%", flexDirection:"column" }}>
        ...
        <div style={{ marginTop:78, fontSize:68, lineHeight:.95, letterSpacing:"-4px", fontWeight:800 }}>Give Kryx the goal.<br/><span style={{ color:"#6d655c", fontWeight:400, fontStyle:"italic" }}>Come back to finished work.</span></div>
        <div style={{ marginTop:"auto", display:"flex", gap:22, fontSize:16, color:"#625b52" }}><span>No card</span><span>·</span><span>$0/month</span><span>·</span><span>Approval stays with you</span></div>
      </div>
      <div style={{ width:"49%", display:"flex", alignItems:"center", paddingLeft:42 }}>
        <div style={{ width:"100%", border:"1px solid #bdb4a4", background:"#fff", display:"flex", flexDirection:"column" }}>
          <div style={{ display:"flex", justifyContent:"space-between", borderBottom:"1px solid #ded7ca", padding:"18px 20px" }}><b>Morning brief</b><span style={{ color:"#087b42", fontWeight:700 }}>3 ready</span></div>
