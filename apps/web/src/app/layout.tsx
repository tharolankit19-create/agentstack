...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: SITE.name, title: `${SITE.name} — Wake up to finished marketing work`, description: SITE.description, url: "/" },
  twitter: { card: "summary_large_image", title: `${SITE.name} — Wake up to finished marketing work`, description: SITE.description, creator: SITE.twitterHandle ? `@${SITE.twitterHandle.replace(/^@/, "")}` : undefined },
